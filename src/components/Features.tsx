...
const Features = () => {
  ...
  return (
    <section id="features" className="py-20 relative">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(79,70,229,0.1)_0%,transparent_50%)]"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div ref={ref} className={`text-center mb-16 transition-all duration-1000 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h2 className="text-4xl md:text-5xl font-bold text-gray-50 mb-6">
            Your All-in-One LinkedIn <span className="bg-gradient-to-r from-indigo-400 to-violet-400 bg-clip-text text-transparent">Content Toolkit</span>
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-50 mb-4 group-hover:text-indigo-400 transition-colors">
                {feature.title}
              </h3>
