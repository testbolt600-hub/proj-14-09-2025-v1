        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start mb-16">
          ...
          <div className={`transition-all duration-1000 ${isInView ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`} style={{ transitionDelay: '0.2s' }}>
            <div className="space-y-6 h-full flex flex-col">
              <div className="bg-white rounded-xl p-6 shadow-lg border border-slate-100 flex-1">
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 border border-green-200 shadow-lg flex-1">
          ...
          <div className={`transition-all duration-1000 ${isInView ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`} style={{ transitionDelay: '0.4s' }}>
            <div className="space-y-6 h-full flex flex-col">
              <div className="bg-white rounded-xl p-6 shadow-lg border border-slate-100 flex-1">
                ...
                <p className="text-slate-600 leading-relaxed">Beat the robots with AI-powered resume optimization that gets you past ATS systems and in front of hiring managers.</p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-slate-100 flex-1">
                ...
                <p className="text-slate-600 leading-relaxed">Generate authentic content that builds real authority while you focus on your actual work. No more writer's block.</p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-slate-100 flex-1">
                ...
                <p className="text-slate-600 leading-relaxed">The better your role, the stronger your content becomes. The stronger your content, the better your opportunities.</p>
              </div>
            </div>
          </div>
        </div>
